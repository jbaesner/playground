 ...
 * @author jbaesner
 */
public class ContainerDispatcherTestSampler extends AbstractJavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		MessageDispatcher service = factory.getService(ConcurrencyManagementType.CONTAINER);
